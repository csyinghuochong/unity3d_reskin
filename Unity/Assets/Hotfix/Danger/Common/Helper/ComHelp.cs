...
namespace ET
{
    ...
    public static class ComHelp
    {
        ...
        public const int CenterZoneId = 1000;
        public const int RobotProgress = 11;
        ...
        /// <returns></returns>
        public static int GetNewServerId(List<ServerItem> serverItems_1,int zone)
        {
        ...
        public static ServerItem GetGetServerItem(List<ServerItem> serverItems, int zone)
        {
        ...
        public static int GetOpenServerDay(List<ServerItem> serverItems,int zone)
        {
            long serverNow = TimeHelper.ServerNow();
            long openSerTime = GetGetServerItem(serverItems, zone).ServerOpenTime;
