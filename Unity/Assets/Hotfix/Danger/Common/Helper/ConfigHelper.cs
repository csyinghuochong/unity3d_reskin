...
namespace ET
{
    ...
    public static class ConfigHelper
    {
        ...
        public static List<string> RelinkRecordUsers = new List<string>() {  "653fbdd2799f390d1c57d305", "18319670288" };
        ...
        //充值购买钻石比例
        public static int RechargeToDiamondRatio = 100;
        //赠送钻石数量
        ...
        {
            int number = 0;
            if (ComHelp.IsGoogleServer(zone))
            {
            ...
            else
            {
                ...
                number = key * RechargeToDiamondRatio + RechargeGive[key];
            }
        ...
        public static Dictionary<long, string> SerialReward = new Dictionary<long, string>()
        {
             ...
             { 5, "1;100000@3;500@10010039;1@10010046;1" },   //20240715  目前好像只生成到第五批。  第六批第七批并没生成序列号。
             { 6, "1;100000@3;500@10010039;1@10010046;1" },   //没用上
             { 7, "1;100000@3;500@10010039;1@10010046;1" },   //没用上

             { 8, "10010039;1" },       //tap签到天数奖励  20240715
             { 9, "10010033;1" },       //tap签到天数奖励  
             { 10, "10010092;1" },      //tap签到天数奖励  
             { 11, "10010083;1" },      //tap签到天数奖励  
        };
        ...
        public static Dictionary<int, string> RechargeReward_EN = new Dictionary<int, string>()
        {
            { 10, "10031014;1@10000143;5@10010045;1@10010086;2@10000141;1"  },
            { 20, "10000202;1@10000143;12@10010045;2@10010086;3@10000150;1" }
        };
        ...
        public static Dictionary<int, string> LevelRewardItem = new Dictionary<int, string>()
        {
            ...
            { 8,  "14100021;1@14100022;1&14100121;1@14100122;1&14100221;1&14100121;1@14100122;1&14100201;1@14100022;1" },       //本职业特色武器 
            { 10, "10031002;1" },       //小松鼠
            { 12, "10010033;1" },       //金钥匙
        ...
        public static List<string> OccRankChengHao = new List<string>() { 
            ...
            "全区第一唤魔者","全区第二唤魔者","全区第三唤魔者",
            "全区第一巨刃士","全区第二巨刃士","全区第三巨刃士"};
        ...
        public static Dictionary<int, string> SingleRechargeReward_EN = new Dictionary<int, string>()
        {
            { 1, "1;100000@10000122;1@10010086;1" },
            { 5, "10000141;1@10000164;1@10000158;1" }, 
            { 10, "10010045;1@10000164;1@10000158;2@10010079;1" }, 
            { 20, "10000135;1@10000164;1@10010086;2@10010079;1" },
            { 30, "10000134;1@10000150;1@10010026;1@10000137;1@10010053;1" },
            { 50, "10000134;1@10000150;1@10010026;1@10000138;1@10010094;1" },
            { 80, "10049101;1@10000150;1@10010026;1@10000137;2@10000143;5" },
            { 100, "10000134;1@10049101;1@10000150;1@10010026;1@10000138;2@10000143;10" }
        };
