namespace ET
{
    public static class NumericType
    {
        ...
        */
        ...
        public const int Now_CommonActDodgePro = 2069;          //普攻闪避
        public const int Base_CommonActDodgePro_Base = Now_SkillDodgePro * 100 + 1;                    //属性累加
        public const int Base_CommonActDodgePro_Mul = Now_SkillDodgePro * 100 + 2;                     //属性乘法
        public const int Base_CommonActDodgePro_Add = Now_SkillDodgePro * 100 + 3;                     //属性附加
        public const int Extra_Buff_CommonActDodgePro_Add = Now_SkillDodgePro * 100 + 11;              //属性Buff附加加法
        public const int Extra_Buff_CommonActDodgePro_Mul = Now_SkillDodgePro * 100 + 12;              //属性Buff附加乘法
