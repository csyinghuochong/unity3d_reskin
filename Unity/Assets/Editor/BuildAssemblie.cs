...
namespace ET
{
    public static class BuildAssemblie
    {
        ...
        {
            BuildAssemblie.BuildMuteAssembly("Code", new[]
            {
                "Assets/Model/",
                "Assets/ModelView/",
                "Assets/Hotfix/",
        ...
        [MenuItem("Tools/Build/BuildCodeRelease(Version+%) _F6")]
        ...
        {
            BuildAssemblie.BuildMuteAssembly("Data", new[]
            {
                "Assets/Model/",
                "Assets/ModelView/",
            }, Array.Empty<string>(), CodeOptimization.Debug);
        ...
        public static void BuildLogic()
        {
            ...
            BuildAssemblie.BuildMuteAssembly(logicFile, new[]
            {
                "Assets/Hotfix/",
                "Assets/HotfixView/",
        ...
        private static void AfterCompiling_old()
        {
            ...
            // 【最简单修复】用 Unity 非阻塞等待，绝不卡死！
            while (EditorApplication.isCompiling || EditorApplication.isUpdating)
            {
                EditorUtility.UnloadUnusedAssetsImmediate(); // 让编辑器能呼吸
                Thread.Sleep(100); // 只睡一点点
            }
