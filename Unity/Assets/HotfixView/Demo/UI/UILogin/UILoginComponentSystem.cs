...
namespace ET
{
	...
	public static class UILoginComponentSystem
    {
		...
		public static async ETTask RequestAllServer(this UILoginComponent self)
		{
			...
			try
			{
				...
				myserver = ComHelp.GetNewServerId(self.AccountInfoComponent.AllServerList, myserver);
   ...
   //         }
		...
		public static void OnGetDeviceOAID(this UILoginComponent self, string oaid)
		{
			...
			if (!PlayerPrefs.GetString("SendHotUpdate_0119c").Equals("1"))
			{
                PlayerPrefs.SetString("SendHotUpdate_0119c", "1");
