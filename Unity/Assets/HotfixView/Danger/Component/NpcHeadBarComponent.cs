    ...
    public static class NpcHeadBarComponentSystem
    {
        ...
        public static void OnRecvTaskUpdate(this NpcHeadBarComponent self)
        {
            ...
            canGets.AddRange(self.GetAddtionTaskId(self.NpcId));
             ...
             self.ShowNpcEffect( 0, ABPathHelper.GetEffetPath("ScenceEffect/Effect_GetTask"), canGets.Count > 0 && taskProCompleted.Count == 0);
             self.ShowNpcEffect( 1, ABPathHelper.GetEffetPath("ScenceEffect/Effect_ComTask"), taskProCompleted.Count > 0);
        }
