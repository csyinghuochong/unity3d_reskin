...
namespace ET
{
    ...
    public class UIServerShowComponentAwake : AwakeSystem<UIServerShowComponent>
    {
        public override void Awake(UIServerShowComponent self)
        {
            ...
            List <ServerItem> serverItems = accountInfoComponent.AllServerList;
            ...
            foreach (var item in self.Iptoservers)
            {
                ...
                ServerItem serverItem = ComHelp.GetGetServerItem(accountInfoComponent.AllServerList, serverId);
