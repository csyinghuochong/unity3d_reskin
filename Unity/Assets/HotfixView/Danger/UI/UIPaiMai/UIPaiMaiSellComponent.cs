...
namespace ET
{
    public class UIPaiMaiSellComponent : Entity, IAwake, IDestroy
    {
    ...
    public class UIPaiMaiSellComponentDestroySystem : DestroySystem<UIPaiMaiSellComponent>
    {
        public override void Destroy(UIPaiMaiSellComponent self)
        {
    ...
    {
        public static void StoreUIdData(this UIPaiMaiSellComponent self)
        {
        ...
        public static void OnLanguageUpdate(this UIPaiMaiSellComponent self)
        {
            Transform tt = self.UIPageButton.GetParent<UI>().GameObject.transform;
