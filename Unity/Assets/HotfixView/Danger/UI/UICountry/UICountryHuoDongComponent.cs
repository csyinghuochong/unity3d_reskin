...
namespace ET
{
    ...
    public class UICountryHuoDongComponentAwakeSystem : AwakeSystem<UICountryHuoDongComponent>
    {
        ...
        public override void Awake(UICountryHuoDongComponent self)
        {
            ...
            int openDay = ComHelp.GetOpenServerDay(self.ZoneScene().GetComponent<AccountInfoComponent>().AllServerList, zone);
    ...
    public static class UICountryHuoDongComponentSystem
    {
        ...
        {
            PopupTipHelp.OpenPopupTip(self.ZoneScene(), GameSettingLanguge.LoadLocalization("角斗场"), GameSettingLanguge.LoadLocalization("是否立即前往角斗场？"), () =>
            {
